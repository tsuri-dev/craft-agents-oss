...
export const CHANNEL_MAP = {
  ...
  getSessionMessagePage: invoke(RPC_CHANNELS.sessions.GET_MESSAGE_PAGE),
  ...
  getUsageStats: invoke(RPC_CHANNELS.sessions.GET_USAGE_STATS),
  ...
  listRequirementComments: invoke(RPC_CHANNELS.requirements.LIST_COMMENTS),
  startRequirementAgentRun: invoke(RPC_CHANNELS.requirements.START_AGENT_RUN),
  replyToRequirementAgent: invoke(RPC_CHANNELS.requirements.REPLY_TO_AGENT),
