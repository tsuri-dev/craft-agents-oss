...
import log, { isDebugMode, mainLog, getLogFilePath, autoUpdateLog } from './logger'
...
app.whenReady().then(async () => {
  ...
  try {
    await cleanupDeprecatedMessagingAndOpenClaw({ logger: mainLog })
  } catch (error) {
    mainLog.warn('[cleanup] deprecated messaging/OpenClaw cleanup failed', {
