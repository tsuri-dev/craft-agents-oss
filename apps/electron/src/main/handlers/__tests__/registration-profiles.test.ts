...
async function getExpectedCoreChannels(): Promise<Set<string>> {
  ...
  const [
    ...
    import('@craft-agent/server-core/handlers/rpc/agent-profiles'),
    import('@craft-agent/server-core/handlers/rpc/agent-runs'),
    ...
    import('@craft-agent/server-core/handlers/rpc/requirements'),
    ...
    import('@craft-agent/server-core/handlers/rpc/ssh'),
  ...
  return new Set([
    ...agentProfiles.HANDLED_CHANNELS,
    ...agentRuns.HANDLED_CHANNELS,
