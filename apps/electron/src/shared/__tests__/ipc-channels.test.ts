...
const EXPECTED_CHANNELS: string[] = [
  ...
  'shell:listDirectoryOpenApps',
  'shell:openDirectoryWithApp',
  'shell:openFile',
  'shell:openUrl',
  'shell:showInFolder',
  'skills:changed',
