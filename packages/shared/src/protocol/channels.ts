...
export const RPC_CHANNELS = {
  ...
  sessions: {
    ...
    GET_USAGE_STATS: 'sessions:getUsageStats',
    EVENT: 'session:event',
  ...
  requirements: {
    ...
    LIST_COMMENTS: 'requirements:listComments',
    START_AGENT_RUN: 'requirements:startAgentRun',
    REPLY_TO_AGENT: 'requirements:replyToAgent',
